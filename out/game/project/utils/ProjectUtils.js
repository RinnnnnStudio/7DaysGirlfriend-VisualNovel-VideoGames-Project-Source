var ProjectUtils = (function () {
    ...
    ProjectUtils.init = function () {
        ...
        stage.on(EventObject.KEY_DOWN, this, function (e) { _this.keyboardEvent = e; if (ArrayUtils.matchAttributes(_this.keyboardEvents, { keyCode: e.keyCode }, true).length == 0) {
